...
(function (Calendar) {
  ...
  var dropdown = $('#dropdown-cal-view');
  var dropdownTrigger = $('#dropdown-cal-view-trigger');
  var dropdownTriggerIcon = $('#dropdown-cal-view-icon');
  var dropdownContent = $('#dropdown-cal-view-content');
  ...
  function setCheckboxBackgroundColor(checkbox) {
    ...
    if (checkbox.checked) {
      checkbox.style.backgroundColor = calendarInfo.backgroundColor;
    } else {
